...
<header>
      <div class="header-container">
         <nav class="header-nav-bar">
				...
				<ul class="header-nav-lists">
						...
						<li class="header-nav-list "><a class="header-nav-link header-active" href="adminopen.php">Buka/Tutup</a></li>
	...
	<?php
							 ...
							 { ?>
								<center>
								<a class="btn btn-success" href="index.php?action=open">OPEN</a>
                                <a class="btn btn-danger" href="index.php?action=close">CLOSE</a>
								</center>	
	<?php } ?>
	<br><br>
        <footer class="footer">
