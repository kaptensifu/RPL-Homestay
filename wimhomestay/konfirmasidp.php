...
<header>
    ...
    <table class="table1" >
		<tr>
			<th>
			"Pembayaran yang kamu lakukan sedang diverifikasi, Kamu akan menerima kwitansi pembayaran pada email kamu"
			</th>
		</tr>
	</table>
	</center>
...
<br><br>
<center>
    <a class="header-btn header-btn-custom" href="index.php">KEMBALI</a>
    </center>
    <br><br>
