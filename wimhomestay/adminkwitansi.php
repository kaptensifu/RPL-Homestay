...
<table class="table table-hover">
  ...
  <?php
							include 'koneksi.php';
							$query = mysqli_query($konek, "select * from kwitansi");
							while ($data = mysqli_fetch_array($query)) { ?>
								<tr>
									<td><?php echo $data['id_pesanan1']; ?></td>
									<td><img src="<?=$data['foto_kwitansi']?>" style="width:100px;height: 150px;object-fit: cover;"></td>
									<td><?php echo $data['tanggal_dibuat']; ?></td>
									<td><?php echo $data['email1']; ?></td>
									<td>
									<a class="btn btn-warning" href="konfirmasikwitansi.php">Kirim Email</a>
									</td>
								</tr>
							<?php } ?>
